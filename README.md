# Packet Control XDP/eBPF Project
...
- **Demo Link**: [Click Here](https://drive.google.com/file/d/18oZKf1BNDBnJwnstm4suq68-jvtxtfva/view?usp=drive_link)
---
...
(We load our compiled program into the kernel):
```
sudo ip link set dev eth0 xdp obj <ebpf object file> sec xdp
```
Check that the `XDP` program is running:
```
